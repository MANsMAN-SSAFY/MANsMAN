...
class OtherWriteArticles extends StatefulWidget {
  String memberId;
  OtherWriteArticles({
    super.key,
  ...
  @override
  State<OtherWriteArticles> createState() => _OtherWriteArticlesState();
}

Future<List<dynamic>> getOtherWriteArticles(String memberId) async {
  final dio = Dio();
  ...
  try {
    final response =
        await dio.get("${dotenv.env['baseUrl']}members/$memberId/boards",
            options: Options(
...
class _OtherWriteArticlesState extends State<OtherWriteArticles> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: getOtherWriteArticles(widget.memberId),
